...
namespace mvcGGMobile.Models
{
    ...
    partial void InsertHangDT(HangDT instance);
    partial void UpdateHangDT(HangDT instance);
    partial void DeleteHangDT(HangDT instance);
    ...
    partial void DeleteCHITIETDONHANG(CHITIETDONHANG instance);
		...
		public dbGGMobileDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["GGMobileConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<HangDT> HangDTs
		{
			get
			{
				return this.GetTable<HangDT>();
			}
		}
	...
	public partial class SanPham : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<HangDT> _HangDT;
    ...
    partial void OnMaHangChanged();
		...
		public SanPham()
		{
			...
			this._HangDT = default(EntityRef<HangDT>);
			OnCreated();
		}
		...
		public System.Nullable<int> MaHang
		{
			...
			set
			{
				...
				{
					if (this._HangDT.HasLoadedOrAssignedValue)
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HangDT_SanPham", Storage="_HangDT", ThisKey="MaHang", OtherKey="MaHang", IsForeignKey=true)]
		public HangDT HangDT
		{
			get
			{
				return this._HangDT.Entity;
			}
			set
			{
				HangDT previousValue = this._HangDT.Entity;
				if (((previousValue != value) 
							|| (this._HangDT.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._HangDT.Entity = null;
						previousValue.SanPhams.Remove(this);
					}
					this._HangDT.Entity = value;
					if ((value != null))
					{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.HangDT")]
	public partial class HangDT : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnTenHangChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HangDT_SanPham", Storage="_SanPhams", ThisKey="MaHang", OtherKey="MaHang")]
